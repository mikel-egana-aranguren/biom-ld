...
/**
 * 
 * A parser for the BIOM attribute generated-by
 * 
...
public class HDF5AttributeGeneratedByParser extends HDF5HObjectParser {
	...
	public void execute(HObject hobject, Store store) throws Exception {
		...
		Attribute attr = super.getMetadataAttributeByName(metadata,"generated-by");
		if (attr == null) {
			throw new BIOMHDF5ParserException(
					"Could not find attribute generated-by in HDF5 file");
		} else {
